# Leituras — a linhagem intelectual desta filosofia
...
Os links abaixo foram conferidos em 13/07/2026. Sempre que possível,
apontam para editora, instituição ou fonte primária.
...
**Links**:
- Leitura em português: https://pt.chabad.org/library/article_cdo/aid/1090121/jewish/Pirkei-Avot-tica-dos-Pais.htm
- PDF em português: https://pt.chabad.org/media/pdf/1066/tthb10661937.pdf
...
**Link**: https://sefer.com.br/products/guia-dos-perplexos
...
**Link**: https://www.vozes.com.br/autor/12430/viktor-e-frankl

## Como estas leituras alimentam o projeto

Ao encontrar uma passagem que mereça virar reza, o caminho é: traduzir
para a lógica prática do cotidiano (formato em
`config/mentor-persona.md`), citar como "a sabedoria milenar ensina..."
ou "a tradição sugere...", e adicionar ao banco correspondente em
`config/rezas.json`.
